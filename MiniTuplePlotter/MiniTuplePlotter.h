...
public :
	...
	// -------------------------------------------------------------------------------------
	void Draw2DPlot( PlotParams myPlotParams_x, PlotParams myPlotParams_y, string filetag_treename, TCut cut_compare ) {
	...
	void Plot2D( PlotParams myPlotParams_x, PlotParams myPlotParams_y ){
		...
		for( auto filetag_treename: filetags_treenames ){
			for( auto cut_compare: cuts_compare ){
				Draw2DPlot(myPlotParams_x, myPlotParams_y, filetag_treename, cut_compare);
			}
		}
