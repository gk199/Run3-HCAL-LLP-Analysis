...
PlotParams P_jet0_Mass					= {"jet0_Mass", "Leading Jet Mass", "Mass", 0, 100 };
...
PlotParams P_jet0_Track0dR				= {"jet0_Track0dR", "Leading Jet: Leading Track #DeltaR", "#DeltaR", 0, 0.6 };
PlotParams P_jet0_Track1dR				= {"jet0_Track1dR", "Leading Jet: Subleading Track #DeltaR", "#DeltaR", 0, 0.6 };
PlotParams P_jet0_Track2dR				= {"jet0_Track2dR", "Leading Jet: Third Leading Track #DeltaR", "#DeltaR", 0, 0.6 };
...
PlotParams P_jet0_SV_Mass				= {"jet0_SV_Mass", "Leading Jet: SV Mass", "SV Mass [GeV]", 0, 10 };
...
PlotParams P_jet0_AllRechitE			= {"jet0_AllRechitE", "Leading Jet Sum of HB Rechit Energy", "Energy [GeV]", 0, 1000 };
...
PlotParams P_jet0_ChargedHadMult		= {"jet0_ChargedHadMult", "Leading Jet Charged Hadron Multiplicity", "Charged Hadron Multiplicity", 0, 60 };
...
PlotParams P_jet0_NeutralOverChargedHad = {"jet0_NeutralHadEFrac/jet0_ChargedHadEFrac", "Leading Jet Neutral / Charged Hadron Energy Fraction", "Neutral / Charged Hadron Energy Fraction", 0, 100};
