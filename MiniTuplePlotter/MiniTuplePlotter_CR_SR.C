...
void MiniTuplePlotter_CR_SR(){
	...
	vector<string> filetags_both = 	{ "v1.2_LLPskim_500k_2023_09_11", "v1.2_MCsignal_500k_2023_09_11" };
	vector<string> filetags_data = 	{ "v1.2_LLPskim_500k_2023_09_11" };
	vector<string> filetags_MC = 	{ "v1.2_MCsignal_500k_2023_09_11" };
	...
	plotter_JetVars.SetPlots({P_jet0_E, P_jet0_Pt, P_jet0_Eta, P_jet0_Phi, 																	 // jet kinematics
								...
								P_jet0_HoverE, P_jet0_HadNeutralOverCharged } );															 // H/E and neutral / charged hadron
	...
	// plotter_Jet1Vars2D_etaphi.SetSelectiveCuts("MCsignal", Cut_LLPinHCAL_Jet1); // region for LLP decay
	// plotter_Jet1Vars2D_etaphi.SetSelectiveCuts("CR_MC", Cut_LLPinCR_Jet1); // region for LLP decay
    ...
    // plotter_Jet1Vars2D_etaphi.Plot2D(P_jet1_EtaSpread, P_jet1_PhiSpread);
    // plotter_Jet1Vars2D_etaphi.Plot2D(P_jet1_EtaSpread_energy, P_jet1_PhiSpread_energy);
