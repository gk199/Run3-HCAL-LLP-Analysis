...
void MiniTuplePlotter_SignalContamination(){
	...
	*/
	...
	vector<string> filetags_both = 	{ "v3.8_LLPskim_Run2023Dv1_2024_06_03_scores", "v3.8_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-50_CTau3000_13p6TeV_2024_06_03_batch1_scores" };
	vector<string> filetags_data = 	{ "v3.8_LLPskim_Run2023Dv1_2024_06_03_scores" };
	vector<string> filetags_MC = 	{ "v3.8_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-50_CTau3000_13p6TeV_2024_06_03_batch1_scores" };
