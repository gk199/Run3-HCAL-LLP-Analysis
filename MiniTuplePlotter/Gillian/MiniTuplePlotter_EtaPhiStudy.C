...
void MiniTuplePlotter_EtaPhiStudy(){
	...
	plotter_overlay2D_HLT.SetPlots2D({Hist1_Hist2(P_jet0_Pt, P_jet0_EtaPhiQuadSpread),
                                    Hist1_Hist2(P_jet0_AllRechitE, P_jet0_EtaPhiQuadSpread), 
                                    Hist1_Hist2(P_jet0_Pt, P_jet0_EtaPhiQuadSpread_energy),
                                    Hist1_Hist2(P_jet0_AllRechitE, P_jet0_EtaPhiQuadSpread_energy) });
