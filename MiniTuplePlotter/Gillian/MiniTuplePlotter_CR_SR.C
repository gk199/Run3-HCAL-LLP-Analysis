...
//										P_jet0_EleEFrac, P_jet0_NeutralElePhoEFrac, 																		// need fix in ntupler!!!
										P_jet0_NeutralPhoEFrac, P_jet0_HoverE, P_jet0_NeutralOverChargedHad, 												// H/E and neutral / charged hadron
	...
	plotter_CutBased.SetLegendNames({"Prompt", "Tracker-NonPrompt", "ECAL", "HCAL-L1", "HCAL-L2", "HCAL-L34"});
	plotter_CutBased.SetLegendPosition( 0.6, 0.7, 0.88, 0.88 );
	plotter_CutBased.SetCuts("jet0_NeutralHadEFrac > 0.6"); 
