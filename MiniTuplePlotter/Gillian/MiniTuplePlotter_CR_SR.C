...
void MiniTuplePlotter_CR_SR(){
	...
	filetags["LLP125_mX15"]	= { "v3.6_LLPskim_Run2023Cv4_2024_03_02", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-15_CTau1000_13p6TeV_2024_03_02_TEST"};
	filetags["LLP350_mX80"]	= { "v3.6_LLPskim_Run2023Cv4_2024_03_02", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-350_MS-80_CTau500_13p6TeV_2024_03_02_TEST"};
	filetags["LLP125"]		= { "v3.6_LLPskim_Run2023Cv4_2024_03_02", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-50_CTau3000_13p6TeV_2024_03_02_batch2"};
	filetags["LLP250"]		= { "v3.6_LLPskim_Run2023Cv4_2024_03_02", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-250_MS-120_CTau10000_13p6TeV_2024_03_02_batch2"};
	filetags["LLP350"]		= { "v3.6_LLPskim_Run2023Cv4_2024_03_02", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-350_MS-160_CTau10000_13p6TeV_2024_03_02_batch2"};

	vector<string> filetags_data 		= { "v3.6_LLPskim_Run2023Cv4_2024_03_02" };
	vector<string> filetags_LLP 		= { "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-50_CTau3000_13p6TeV_2024_03_02_batch2" };	
	vector<string> filetags_all 		= { "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-15_CTau1000_13p6TeV_2024_03_02_TEST", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-350_MS-80_CTau500_13p6TeV_2024_03_02_TEST", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-125_MS-50_CTau3000_13p6TeV_2024_03_02_batch2", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-250_MS-120_CTau10000_13p6TeV_2024_03_02_batch2", "v3.6_LLP_MC_ggH_HToSSTobbbb_MH-350_MS-160_CTau10000_13p6TeV_2024_03_02_batch2"};
...
//										P_jet0_EleEFrac, P_jet0_NeutralElePhoEFrac, 																		// need fix in ntupler!!!
	...
	if (LLP_WJets) {
		...
		for( auto key: filetag_keys_to_loop){
			...
			// plotter_BDTvars.SetOutputFileTag("Overlay_"+key+"_v3.6");
			...
			plotter_BDTvars_perJet.SetOutputFileTag("Overlay_perJet_"+key+"_v3.6");
	...
	if (track_dR_study) {
		...
		for( auto key: filetag_keys_to_loop){
			...
			plotter_track_dR.SetOutputFileTag("Overlay_perJet_"+key+"_v3.6");
			...
			plotter_dR_track.SetOutputFileTag("Overlay_perJet_"+key+"_v3.6");
			...
			plotter_dR_cdf.SetOutputFileTag("Overlay_perJet_"+key+"_v3.6");
			plotter_dR_cdf.plot_log_ratio    = false;
			plotter_dR_cdf.plot_reverse_cdf  = true;
	...
	if (overlay_LLP) {
		...
		plotter_BDTvars_perJet.SetOutputFileTag("Overlay_perJet_allLLP_v3.6");
		plotter_BDTvars_perJet.plot_log_ratio    = false; 
		//plotter_BDTvars_perJet.plot_cdf 		 = true;
		//plotter_BDTvars_perJet.plot_reverse_cdf  = true;
		plotter_BDTvars_perJet.SetLegendPosition( 0.6, 0.7, 0.88, 0.88 );
	...
	if (Bkg_est) {
		...
		plotter_BkgEst.SetOutputFileTag("Jet40_CR_SR_v3.6_MC"); 	
	...
	if (LLP_all) {
		...
		plotter_JetVars.SetOutputFileTag("Jet40_CR_SR_v3.6_MC"); 	
		...
		plotter_TrackVars.SetOutputFileTag("Jet40_Track4_CR_SR_v3.6_MC"); 	
		...
		plotter_JetVars2D_etaphi.SetOutputFileTag("Jet40_CR_SR_v3.6_MC"); 	
	...
	if (Jet_vars) {
		...
		plotter_Jet0KinematicVars.SetOutputFileTag("CR_SR_v3.6_MC"); 	
		...
		plotter_Jet1KinematicVars.SetOutputFileTag("CR_SR_v3.6_MC"); 	
	...
	if (NH_bins) {
		...
		plotter_RechitVars_NHBinsData.SetOutputFileTag("NeutralHadBins_Jet40_v3.6"); 	
		...
		plotter_RechitVars_NHBins.SetOutputFileTag("NeutralHadBins_Jet40_v3.6_MC"); 	
	...
	if (Jet_bins) {
		...
		plotter_allVars_JetBinsData.SetOutputFileTag("JetpTBins_Jet40_v3.6"); 	
		...
		plotter_allVars_JetBins.SetOutputFileTag("JetpTBins_Jet40_v3.6_MC"); 	
	...
	if (BDT_bins) {
		...
		plotter_allVars_BDTbinsData.SetOutputFileTag("BDTBins_Jet40_v3.6"); 	
		...
		plotter_allVars_BDTBins.SetOutputFileTag("BDTBins_Jet40_v3.6_MC"); 	
	...
	if (Matching_efficiency) {
		...
		plotter_LLP_Jet_PtDiff.SetOutputFileTag("Jet40_v3.6_MC"); 	
		...
		plotter_LLP_Jet_Match.SetOutputFileTag("Jet40_v3.6_MC"); 	
		...
		plotter_LLP_Jet_Match_tight.SetOutputFileTag("Jet40_v3.6_MC"); 	
