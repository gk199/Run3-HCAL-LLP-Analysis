...
PlotParams P_PV				= {"PV", "Number of Primary Vertices", "N_{PV}", 10, 80 };
...
PlotParams P_jet0_Eta					= {"jet0_Eta", "Leading Jet #eta", "Jet #eta", -2.5, 2.5 };
...
PlotParams P_jet0_dEta					= {"abs(jet0_Eta) - abs(jet1_Eta)", "Leading-subleading Jet #Delta#eta", "Jet #Delta#eta", -3, 3 };
PlotParams P_jet0_dPhi					= {"abs(jet0_jet1_dPhi)", "Leading-subleading Jet #Delta#phi", "Jet #Delta#phi", 0, 3.2 };
...
PlotParams P_jet0_AllRechitEFracJet		= {"jet0_AllRechitE / jet0_E", "Fraction of HB Rechit Energy in Leading Jet", "Fraction of HB Rechit Energy", 0, 1 };
...
PlotParams P_jet0_SubLeadingRechitEFracJet	= {"jet0_SubLeadingRechitE / jet0_E", "Leading Jet: Subleading Rechit Energy / Jet Energy", "Energy Fraction", 0, 1 };
PlotParams P_jet0_SSubLeadingRechitEFracJet	= {"jet0_SSubLeadingRechitE / jet0_E", "Leading Jet: SubsubLeading Rechit Energy / Jet Energy", "Energy Fraction", 0, 1 };
...
PlotParams P_jet0_SubLeadingRechitEFrac	 = {"jet0_SubLeadingRechitE / jet0_AllRechitE", "Leading Jet: Leading Rechit Energy / Sum of HB Rechit Energy", "Energy Fraction", 0, 1 };
PlotParams P_jet0_SSubLeadingRechitEFrac	= {"jet0_SSubLeadingRechitE / jet0_AllRechitE", "Leading Jet: Leading Rechit Energy / Sum of HB Rechit Energy", "Energy Fraction", 0, 1 };
...
PlotParams P_jet1_Eta					= {"jet1_Eta", "Sub-Leading Jet #eta", "#eta (sub-leading jet)", -2.5, 2.5 };
...
// Subleading jet training 
PlotParams P_jet1_Mass = {"jet1_Mass", "Subleading Jet Mass", "Jet Mass", 0, 40 };
PlotParams P_jet1_Setaeta 				={"jet1_S_etaeta", "Subleading Jet S #eta#eta", "S #eta#eta", 0, 0.15 };
PlotParams P_jet1_Sphiphi 				={"jet1_S_phiphi", "Subleading Jet S #phi#phi", "S #phi#phi", 0, 0.15 };
PlotParams P_jet1_Setaphi 				={"jet1_S_etaphi", "Subleading Jet S #eta#phi", "S #eta#phi", 0, 0.15 };
PlotParams P_jet1_Tracks_dR				= {"jet1_Tracks_dR", "Leading Jet: Leading Track to Sub-leading Track #DeltaR", "#DeltaR (leading, subleading track)", 0, 1.0 };
PlotParams P_jet1_Track0dR				= {"jet1_Track0dR", "Subleading Jet to Leading Track #DeltaR", "#DeltaR", 0, 0.5 };
PlotParams P_jet1_Track1dR				= {"jet1_Track1dR", "Subleading Jet to Subleading Track #DeltaR", "#DeltaR", 0, 0.5 };
PlotParams P_jet1_Track2dR				= {"jet1_Track2dR", "Subleading Jet to Third Leading Track #DeltaR", "#DeltaR", 0, 0.5 };
PlotParams P_jet1_Track0dEta			= {"jet1_Track0dEta", "Subleading Jet to Leading Track #Delta#eta", "#Delta#eta", 0, 0.5 };
PlotParams P_jet1_Track1dEta			= {"jet1_Track1dEta", "Subleading Jet to Subleading Track #Delta#eta", "#Delta#eta", 0, 0.5 };
PlotParams P_jet1_Track2dEta			= {"jet1_Track2dEta", "Subleading Jet to Third Leading Track #Delta#eta", "#Delta#eta", 0, 0.5 };
PlotParams P_jet1_Track0dPhi			= {"jet1_Track0dPhi", "Subleading Jet to Leading Track #Delta#phi", "#Delta#phi", 0, 0.5 };
PlotParams P_jet1_Track1dPhi			= {"jet1_Track1dPhi", "Subleading Jet to Subleading Track #Delta#phi", "#Delta#phi", 0, 0.5 };
PlotParams P_jet1_Track2dPhi			= {"jet1_Track2dPhi", "Subleading Jet to Third Leading Track #Delta#phi", "#Delta#phi", 0, 0.5 };
PlotParams P_jet1_Track0PtFrac			= {"jet1_Track0Pt / jet1_Pt", "Subleading Jet: Leading Track p_{T} / Jet p_{T}", "Track Energy Fraction", 0, 1 };
PlotParams P_jet1_Track1PtFrac			= {"jet1_Track1Pt / jet1_Pt", "Subleading Jet: Subleading Track p_{T} / Jet p_{T}", "Track Energy Fraction", 0, 1 };
PlotParams P_jet1_Track2PtFrac			= {"jet1_Track2Pt / jet1_Pt", "Subleading Jet: Third Leading Track p_{T} / Jet p_{T}", "Track Energy Fraction", 0, 1 };
PlotParams P_jet1_EnergyFrac_Depth1		= {"jet1_EnergyFrac_Depth1", "Subleading Jet: Energy Fraction in HCAL Depth 1", "Energy Fraction", 0, 1.01 };
PlotParams P_jet1_EnergyFrac_Depth2		= {"jet1_EnergyFrac_Depth2", "Subleading Jet: Energy Fraction in HCAL Depth 2", "Energy Fraction", 0, 1.01 };
PlotParams P_jet1_EnergyFrac_Depth3		= {"jet1_EnergyFrac_Depth3", "Subleading Jet: Energy Fraction in HCAL Depth 3", "Energy Fraction", 0, 1.01 };
PlotParams P_jet1_EnergyFrac_Depth4		= {"jet1_EnergyFrac_Depth4", "Subleading Jet: Energy Fraction in HCAL Depth 4", "Energy Fraction", 0, 1.01 };
PlotParams P_jet1_LeadingRechitD		= {"jet1_LeadingRechitD", "Subleading Jet: Leading Rechit Depth", "HCAL Depth", 0, 5 };
PlotParams P_jet1_LeadingRechitEFrac	 = {"jet1_LeadingRechitE / jet1_AllRechitE", "Subleading Jet: Leading Rechit Energy / Sum of HB Rechit Energy", "Energy Fraction", 0, 1 };
PlotParams P_jet1_SubLeadingRechitEFrac	 = {"jet1_SubLeadingRechitE / jet1_AllRechitE", "Subleading Jet: Leading Rechit Energy / Sum of HB Rechit Energy", "Energy Fraction", 0, 1 };
PlotParams P_jet1_SSubLeadingRechitEFrac = {"jet1_SSubLeadingRechitE / jet1_AllRechitE", "Subleading Jet: Leading Rechit Energy / Sum of HB Rechit Energy", "Energy Fraction", 0, 1 };
PlotParams P_jet1_AllRechitE			= {"jet1_AllRechitE", "Subleading Jet: Sum of HB Rechit Energy", "Sum of HB Rechit Energy [GeV]", 0, 300 };
...
PlotParams P_perJet_AllRechitEFracJet		= {"perJet_AllRechitE / perJet_E", "Total HB Rechit Energy over Jet Energy", "Energy Fraction", 0, 1.01 };
...
PlotParams P_perJet_LeadingRechitEFracJet	= {"perJet_LeadingRechitE / perJet_E", "Leading HB Rechit Energy over Jet Energy", "Energy Fraction", 0, 1 };
