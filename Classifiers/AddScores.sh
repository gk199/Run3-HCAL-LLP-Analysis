...
# python3 Evaluate/ScoresToEventBased_iterate.py -f /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_HToSSTo4B_250_120_CTau10000.root -t NoSel -d Evaluate/depth_model_v6.keras -i Evaluate/inclusive_model_v6.keras -c Evaluate/norm_constants_v4.csv -m filewrite
# python3 Evaluate/ScoresToEventBased_iterate.py -f /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_HToSSTo4B_350_160_CTau10000.root -t NoSel -d Evaluate/depth_model_v6.keras -i Evaluate/inclusive_model_v6.keras -c Evaluate/norm_constants_v4.csv -m filewrite
