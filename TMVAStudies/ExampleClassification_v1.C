...
int runClassification( TString dir, TString sigTag, TString bkgTag )
{
   ...
   TCut selections_safety = "jet0_EtaSpread > 0 && jet0_NeutralHadEFrac > 0 && jet0_ChargedHadEFrac > 0 && jet0_EnergyFrac_Depth1 > 0.01 && jet0_EnergyFrac_Depth1 < 0.99 && jet0_Track1Pt > 0";
