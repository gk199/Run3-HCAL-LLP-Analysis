...
/eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v3.0/minituple_v3.0_LLPskim_Run2023Bv1_Cv1_Cv2_Cv3_Cv4_Dv1_Dv2_2023_11_17.root
```
...
Note that v3 minituples for LLP MC (125GeV) are currently run over v2 ntuples (which don't have the isolation variables, but those are only needed for W+Jets). The W+Jets tree must be commented out for these.