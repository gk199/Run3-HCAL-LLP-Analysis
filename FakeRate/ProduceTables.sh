...
# python3 OutputToLatex_combined.py -e 2022_DEF -s 0.7 -b
# python3 OutputToLatex_combined.py -e 2022_DEF -s 0.8 -b 
# python3 OutputToLatex_combined.py -e 2022_DEF -s 0.9 -b 
python3 OutputToLatex_combined.py -e 2022_G -s 0.7 -b
python3 OutputToLatex_combined.py -e 2022_G -s 0.8 -b 
python3 OutputToLatex_combined.py -e 2022_G -s 0.9 -b 
...
# python3 OutputToLatex.py -e 2022_DEF -s 0.7 
# python3 OutputToLatex.py -e 2022_DEF -s 0.8 
# python3 OutputToLatex.py -e 2022_DEF -s 0.9 
