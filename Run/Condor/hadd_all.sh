...
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Cv1.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023C-EXOLLPJetHCAL-PromptReco-v1_AOD_v5/minituple_job*.root
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Cv2.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023C-EXOLLPJetHCAL-PromptReco-v2_AOD_v5/minituple_job*.root
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Cv3.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023C-EXOLLPJetHCAL-PromptReco-v3_AOD_v5/minituple_job*.root
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Cv4.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023C-EXOLLPJetHCAL-PromptReco-v4_AOD_v5/minituple_job*.root
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Dv1.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023D-EXOLLPJetHCAL-PromptReco-v1_AOD_v5/minituple_job*.root
hadd -j /eos/cms/store/group/phys_exotica/HCAL_LLP/MiniTuples/v5.5/minituple_data_2023Dv2.root /eos/user/g/gkopp/LLP_Analysis/MiniTuples/v5.5/DisplacedJet_Run2023D-EXOLLPJetHCAL-PromptReco-v2_AOD_v5/minituple_job*.root